...
namespace SismaV02.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CodServicio,Descripcion")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CodServicio,Descripcion")] Servicio servicio)
        {
            if (ModelState.IsValid)
            {
